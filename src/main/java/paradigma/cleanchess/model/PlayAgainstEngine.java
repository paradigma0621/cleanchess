...
public static void createScriptFile(String FENatual) {	
	...
	try {
		...
		writer.println(") | /home/lucas/Documentos/xadrez/java/xadrezQueEstaValendo-16.9/cleanchess/src/main/resources/executable/stockfish > /home/lucas/Documentos/xadrez/java/xadrezQueEstaValendo-16.9/cleanchess/src/main/resources/playedGames/out-X3");
		writer.close();
	...
	public static String readEngineOutput() {
		...
		File file = new File("/home/lucas/Documentos/xadrez/java/xadrezQueEstaValendo-16.9/cleanchess/src/main/resources/playedGames/out-X3");
		Scanner sc = null;
		try {
			sc = new Scanner(file);
